...
<head>
	<meta charset="utf-8">
	<title>Suspender Producto</title>
...
<section>
	...
	<?php
		...
		$consulta = mysqli_query($base_datos, "SELECT * FROM productos WHERE Estado = 'suspendido'");
	...
	<div id="productos">
		...
		<p><a href="suspender.php?cod=<?php echo $lista_productos['ID_Producto'];?>&estado=suspendido"> Activar </a></p>
	</div>
